<script lang="ts">
  import { getGameStateV4, answerQuestionV4, nextQuestionV4, prevQuestionV4, submitAllV4 } from "$lib/stores/game-v4.svelte";
  import WelcomeScreenV4 from "$lib/components/WelcomeScreenV4.svelte";
  ...
  import DoneScreenV4 from "$lib/components/DoneScreenV4.svelte";

  const game = getGameStateV4();

  function handleAnswer(questionId: string, value: string) {
    answerQuestionV4(questionId, value);
  }
