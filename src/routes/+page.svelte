<main class="min-h-svh flex items-center justify-center px-5 py-10">
  <div class="w-full max-w-sm md:max-w-2xl mx-auto text-center">
    <h1 class="text-5xl font-bold text-gray-950 mb-8">Hoi</h1>
    ...
    <a
      href="/v10"
      class="inline-block rounded-xl bg-indigo-600 px-12 py-4 text-xl font-semibold text-white shadow-lg
