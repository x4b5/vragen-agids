<script lang="ts">
	import { getGameStateV7 } from '$lib/stores/game-v7.svelte';
		...
		<div class="mb-8">
			...
			{:else if game.submissionStatus === 'queued'}
				...
				<p class="text-lg text-amber-600 mb-2">
					Je antwoorden zijn lokaal opgeslagen en worden automatisch verzonden zodra de verbinding hersteld is.
				</p>
			{:else}
