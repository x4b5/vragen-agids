<script lang="ts">
	...
	let totalAnswered = $derived(game.answers.size);
</script>
	...
	<div class="w-full max-w-md text-center">
		<div class="mb-8">
			{#if game.submissionStatus === 'submitting'}
				...
				<h1 class="text-3xl font-bold text-gray-950 mb-3">Even geduld...</h1>
				<p class="text-lg text-gray-700 mb-2">Verzenden...</p>
			{:else if game.submissionStatus === 'queued'}
				...
				<h1 class="text-3xl font-bold text-gray-950 mb-3">Bedankt voor je tijd!</h1>
				<p class="text-lg text-amber-700 mb-2">
			...
			{:else}
				...
				<h1 class="text-3xl font-bold text-gray-950 mb-3">Bedankt voor je tijd!</h1>
				<p class="text-lg text-gray-700 mb-2">Je antwoorden zijn succesvol verzonden.</p>
			{/if}
		</div>

		<div class="rounded-2xl bg-gray-50 p-6 mb-8">
			<p class="text-3xl font-bold text-indigo-600">{totalAnswered}</p>
			<p class="text-base text-gray-700">Vragen beoordeeld</p>
		</div>

		<p class="text-base text-gray-600">Je kunt dit venster sluiten.</p>
	</div>
</main>
